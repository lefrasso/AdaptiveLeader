...
import { SelfAssessment } from "@/components/assessments/self-assessment";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "self" });
...
export default async function SelfAssessmentPage({ params }: Props) {
  ...
  const t = await getTranslations("self");
